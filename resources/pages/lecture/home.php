...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <p style="font:80px; font-weight:400; color:blue; text-align:center; padding-top:2px;">يرجى تحديد التخصص والمادة والمكان أولاً. قبل إطلاق خاصية التعرف على الوجه</p>
            <form class="lecture-options" id="selectForm">
                <select required name="course" id="courseSelect" onChange="updateTable()">
                    <option value="" selected>اختار التخصص</option>
                    <?php
                ...
                <select required name="venue" id="venueSelect" onChange="updateTable()">
                    <option value="" selected>اختار المكان</option>
                    <?php
            ...
            <div class="attendance-button">
                <button id="startButton" class="add">إطلاق التعرف على الوجه</button>
                <button id="endButton" class="add" style="display:none">عملية الحضور النهائية</button>
                <button id="endAttendance" class="add">إنهاء تسجيل الحضور</button>
            </div>
