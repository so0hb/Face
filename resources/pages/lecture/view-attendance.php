...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <button class="add" onclick="exportTableToExcel('attendaceTable', '<?php echo $unitCode ?>_on_<?php echo date('Y-m-d'); ?>','<?php echo $coursename ?>', '<?php echo $unitname ?>')">تصدير الحضور بصيغة Excel</button>
