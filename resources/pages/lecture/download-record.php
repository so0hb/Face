...
// جلب أسماء الكورس والوحدة الدراسية
$coursename = "";
if (!empty($courseCode)) {
...
// جلب جميع التواريخ المميزة للحضور لهذه المادة
...
// جلب بيانات الطلاب مع أسمائهم
$studentsQuery = "SELECT DISTINCT a.studentRegistrationNumber, s.studentName 
                 FROM tblattendance a
                 JOIN tblstudent s ON a.studentRegistrationNumber = s.registrationNumber
...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <button class="add" onclick="exportTableToExcel('attendaceTable', '<?php echo $unitCode . '_on_' . date('Y-m-d'); ?>','<?php echo $coursename ?>', '<?php echo $unitname ?>')">تصدير الحضور بصيغة Excel</button>

            <div class="table-container">
                <div class="title">
                    <h2 class="section--title">معاينة الحضور</h2>
                </div>
